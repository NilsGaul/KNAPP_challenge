...
#include "more_interfaces/msg/detail/order__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const more_interfaces::msg::Order & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  more_interfaces::msg::Order & ros_message)
{
  // Member: order_id
  cdr >> ros_message.order_id;
...
{
  auto typed_message =
    static_cast<const more_interfaces::msg::Order *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<more_interfaces::msg::Order *>(
    untyped_ros_message);
...
{
  return &more_interfaces::msg::typesupport_fastrtps_cpp::_Order__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, more_interfaces, msg, Order)() {
  return &more_interfaces::msg::typesupport_fastrtps_cpp::_Order__handle;
}
