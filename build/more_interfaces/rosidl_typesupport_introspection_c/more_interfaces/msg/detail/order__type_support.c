...
#include <stddef.h>
#include "more_interfaces/msg/detail/order__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  more_interfaces__msg__Order__init(message_memory);
}

void Order__rosidl_typesupport_introspection_c__Order_fini_function(void * message_memory)
{
  more_interfaces__msg__Order__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Order__rosidl_typesupport_introspection_c__Order_message_member_array[2] = {
  {
    ...
    offsetof(more_interfaces__msg__Order, order_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(more_interfaces__msg__Order, description),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Order__rosidl_typesupport_introspection_c__Order_message_members = {
  ...
  "Order",  // message name
  2,  // number of fields
  sizeof(more_interfaces__msg__Order),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, more_interfaces, msg, Order)() {
