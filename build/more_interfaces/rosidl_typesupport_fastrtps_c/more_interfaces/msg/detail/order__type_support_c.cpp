...
#include "more_interfaces/msg/detail/order__rosidl_typesupport_fastrtps_c.h"
...
using _Order__ros_msg_type = more_interfaces__msg__Order;
...
size_t get_serialized_size_more_interfaces__msg__Order(
  const void * untyped_ros_message,
...
static uint32_t _Order__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_more_interfaces__msg__Order(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
size_t max_serialized_size_more_interfaces__msg__Order(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_more_interfaces__msg__Order(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, more_interfaces, msg, Order)() {
