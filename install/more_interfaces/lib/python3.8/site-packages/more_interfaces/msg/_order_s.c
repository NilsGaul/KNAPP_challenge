...
bool more_interfaces__msg__order__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("more_interfaces.msg._order.Order", full_classname_dest, 32) == 0);
  }
  more_interfaces__msg__Order * ros_message = _ros_message;
  {  // order_id
    ...
    ros_message->order_id = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // description
...
PyObject * more_interfaces__msg__order__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("more_interfaces.msg._order");
  ...
  {  // order_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->order_id);
    {
